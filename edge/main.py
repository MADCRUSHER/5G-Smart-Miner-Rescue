...
def logic(data:vestdata):
	...
	miners.append({"id": "Miner 102", "category": status(8), "heartrate": 915, "gas level": 100, "Temp": 38.5})
	miners.append({"id": "Miner 103", "category": status(5), "heartrate": 945, "gas level": 50, "Temp": 37.8})
	miners.append({"id": "Miner 104", "category": status(10), "heartrate": 850, "gas level": 10, "Temp": 37.0})
